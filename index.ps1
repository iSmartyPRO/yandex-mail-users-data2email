...
$active_users_html = ConvertTo-HtmlTable -header ($config.tableHeaders) -dataKeys ('id', 'lastName', 'firstName', 'email', 'position', 'gender', 'createdAt', 'updatedAt') -dataValues $active_users
$inactive_users_html = ConvertTo-HtmlTable -header ($config.tableHeaders) -dataKeys ('id', 'lastName', 'firstName', 'email', 'position', 'gender', 'createdAt', 'updatedAt') -dataValues $inactive_users
